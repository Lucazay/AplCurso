...
<form name="cadastrarestado" action="EstadoCadastrar" method="POST">
    <table align="center" border="0">
        ...
        <tbody>
            ...
            <tr><td>Nome:</td>
                <td><input type="test" name="nomeestado" id="nomeestado" value="${estado.nomeEstado}" size="50" maxlength="50"/></td></tr>
            <tr><td>Sigla:</td>
                <td><input type="text" name="sigaestado" id="siglaestado" value="${estado.siglaEstado}"/></td></tr>
